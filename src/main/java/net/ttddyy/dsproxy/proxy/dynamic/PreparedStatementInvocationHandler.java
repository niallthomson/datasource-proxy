...
public class PreparedStatementInvocationHandler extends AbstractStatementInvocationHandler<PreparedStatement> {
	...
	protected static Set<String> getMethodsToOperateList() {
	...
	protected static Set<String> getMethodsToInterceptList() {
	...
	protected static Set<String> getParameterMethods() {
		return PARAMETER_METHODS;
	}
